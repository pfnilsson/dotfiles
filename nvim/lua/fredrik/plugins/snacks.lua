						...
						win = {
							list = {
								keys = {
									...
									["åc"] = "explorer_git_next",
									["Åc"] = "explorer_git_prev",
									["åd"] = "explorer_diagnostic_next",
									["Åd"] = "explorer_diagnostic_prev",
									["åw"] = "explorer_warn_next",
									["Åw"] = "explorer_warn_prev",
									["åe"] = "explorer_error_next",
									["Åe"] = "explorer_error_prev",
								},
							},
						},
					})
