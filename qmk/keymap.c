...
// AltGr (Right Alt) combos → Shift + F1..F11
// Keys: 1, a, d, f, h, j, k, l, n, p
// Only triggers with Right Alt held (AltGr).
const key_override_t altgr_1 = ko_make_basic(MOD_BIT(KC_RALT), KC_1, S(KC_F1));
const key_override_t altgr_a = ko_make_basic(MOD_BIT(KC_RALT), KC_A, S(KC_F2));
const key_override_t altgr_d = ko_make_basic(MOD_BIT(KC_RALT), KC_D, S(KC_F3));
const key_override_t altgr_f = ko_make_basic(MOD_BIT(KC_RALT), KC_F, S(KC_F4));
const key_override_t altgr_h = ko_make_basic(MOD_BIT(KC_RALT), KC_H, S(KC_F5));
const key_override_t altgr_j = ko_make_basic(MOD_BIT(KC_RALT), KC_J, S(KC_F6));
const key_override_t altgr_k = ko_make_basic(MOD_BIT(KC_RALT), KC_K, S(KC_F7));
const key_override_t altgr_l = ko_make_basic(MOD_BIT(KC_RALT), KC_L, S(KC_F8));
...
const key_override_t altgr_w = ko_make_basic(MOD_BIT(KC_RALT), KC_W, C(S(KC_O)));

const key_override_t *key_overrides[] = {
    &altgr_1, &altgr_a, &altgr_d, &altgr_f, &altgr_h,
    &altgr_j, &altgr_k, &altgr_l, &altgr_n, &altgr_p,
    &altgr_eql, &altgr_t, &altgr_w,
};
